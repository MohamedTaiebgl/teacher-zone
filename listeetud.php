...
<html>
    ...
    if($c=='1')
    {
        $sql = "SELECT * FROM etudiants where grade='7eme';";
    }

    else{if($c=='2')
    {
        $sql = "SELECT * FROM etudiants where grade='8eme';";
    }
    else{if($c=='3')
    {
        $sql = "SELECT * FROM etudiants where grade='9eme';";
    }
    else{if($c=='4')
    {
        $sql = "SELECT * FROM etudiants where grade='1ere';";
    }
    else{if($c=='5')
    {
        $sql = "SELECT * FROM etudiants where grade='2eme' and specialty='sciences';";
    }
    else{if($c=='6')
    {
        $sql = "SELECT * FROM etudiants where grade='2eme' and specialty='informatique';";
    }
    else{if($c=='7')
    {
        $sql = "SELECT * FROM etudiants where grade='2eme' and specialty='economique';";
    }
    else{if($c=='8')
    {
        $sql = "SELECT * FROM etudiants where grade='3eme' and specialty='sciences';";
    }
    else{if($c=='9')
    {
        $sql = "SELECT * FROM etudiants where grade='3eme' and specialty='informatique';";
    }
    else{if($c=='10')
    {
        $sql = "SELECT * FROM etudiants where grade='3eme' and specialty='technique';";
        
    }
    else{if($c=='11')
    {
        $sql = "SELECT * FROM etudiants where grade='3eme' and specialty='economique';";
    }
    else{if($c=='12')
    {
        $sql = "SELECT * FROM etudiants where grade='bac' and specialty='sciences';";
    }
    else{if($c=='13')
    {
        $sql = "SELECT * FROM etudiants where grade='bac' and specialty='informatique';";
    }
    else{if($c=='14')
    {
        $sql = "SELECT * FROM etudiants where grade='bac' and specialty='technique';";
    }
    else{if($c=='15')
    {
        $sql = "SELECT * FROM etudiants where grade='bac' and specialty='economique';";
    }}}}}}}}}}}}}}}
